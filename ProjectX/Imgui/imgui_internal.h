...
namespace ImGui
{
    ...
    IMGUI_API void          ItemSize(const ImVec2& size, float text_ADDRESS_y = 0.0f);
    IMGUI_API void          ItemSize(const ImRect& bb, float text_ADDRESS_y = 0.0f);
    ...
    IMGUI_API float         GetColumnOffsetFromNorm(const ImGuiColumns* columns, float ADDRESS_norm);
